$(document).ready(function () {
    ...
    ////////////////////////////////////////////////////////////////////////////
    var rew_duration    = 2000; // how many MILLISECONDS to show the reward for 
    var wait            = 2000; // how many MILLISECONDS to wait befor saying you are too late 
    var wait_intro      = 700;  // how many MILLISECONDS show each digit (1 , 2 , 3 !) shows on the screen 
    var wait_missedit   = 1000; // how many MILLISECONDS to wait in missed it page 
    var wait_break      = 60;   // how many SECONDS to wait for the break
        
    var trial_break = 95; // every how many trials to have a break

    
//    var Instruct = false;
        var Instruct = true; // to instructions or no 

    ////////////////////////////////////////////////////////////////////////////
        var NumTrials = 5; // cant be more then 365
//    var NumTrials = 15; // setting smaller than 365  only for debugging only, experiment should always be 365
    ////////////////////////////////////////////////////////////////////////////
    ...
    function Instructions(PageNum,ID) {
        ...
        var NumPages = 13;//number of pages
...
<H2 align = "center"> Please dont close this page and call the experimenter </H2></div>';
    ...
    function Step_ShowData() {
        ...
        var Title = '<div id = "Title"><H2 align = "center"> The output data </H2>';
        ...
        var Title = '<div id = "Title"><p> ID       = [' + Subject_ID + '];<br>\n\
                                           Trial    = [' + Trial      + '];<br>\n\
                                           level    = [' + level      + '];<br>\n\
                                           Action   = [' + Action     + '];<br>\n\
                                           RT1      = [' + RT1        + '];<br>\n\
