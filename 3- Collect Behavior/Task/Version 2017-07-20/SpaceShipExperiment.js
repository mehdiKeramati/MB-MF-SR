$(document).ready(function () {
    ...
    ////////////////////////////////////////////////////////////////////////////
    //// time constraint in miliseconds 
    var wait = 4000;
    //    var wait = 4000;
    
    var NumTrials = 365; // cant be more then 365
    var total_trials = NumTrials-1; // when to end the experiment
    ////////////////////////////////////////////////////////////////////////////
    ...
    function Step_setup(ID) {
        ...
        function arrange() {
            ...
            if (S2 === 0)    {
                S2_Img = 'Planet_Gray.png';     S2_name = 'Gray Dust';
                S3_Img = 'Planet_Brown.png';    S3_name = 'Brown Dust';
            }    else if (S2 === 1)  {
                S2_Img = 'Planet_Gray.png';     S2_name = 'Gray Dust';
                S3_Img = 'Planet_Brown.png';    S3_name = 'Brown Dust';
            };
            ...
            Step_pre_trial(1); // perhaps should probably start with trial 1
